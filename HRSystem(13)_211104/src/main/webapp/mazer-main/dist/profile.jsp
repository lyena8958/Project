...
<script type="text/javascript">
	function profileDownload() {
		...
		if (!(career.checked || school.checked || license.checked)) {
			alert('최소 한개 이상 선택해 주세요.');
			return false;
		}
		window.open("profile.do", "_blank", "width=500,height=600");
		// 내일 컨트롤에 각 name check여부 전달해야함
	}
</script>
</head>
				...
				<div class="page-title">
					<div class="row">
						<div class="col-12 col-md-6 order-md-1 order-last">
							<h3>사원 Profile</h3>
							<p class="text-subtitle text-muted">버튼을 선택해 주세요.</p>
						</div>
						...
						<div class="col-12">
							<div class="card" id="pContent">
								<div class="card-header">
									<h4 class="card-title">데이터 조회목록</h4>
								</div>
									...
									<div class="card-body">
										...
										<div class="row mt-3">
											<div class="col-md-6 col-12">
												<button id="info"
													class="btn btn-outline-info btn-lg btn-block" onClick="profileDownload();">download</button>
											</div>
										</div>
									</div>
								</div>
