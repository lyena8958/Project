...
public class MemberDAO {
	...
	// 사번 재직자 조회
	private String GET_work = "SELECT * FROM member WHERE mnum=? AND WORK='재직'";
	...
	//[LIST]
	public List<MemberVO> getList(String text) {
		Object[] args = {"%"+text+"%"};
		return jdbcTemplate.query(GET_LIST, args, new MemberRowMapper());
