...
function profileDownload() {
	...
	if (!(boxs[0].checked || boxs[1].checked || boxs[2].checked)) {
		alert('최소 한개 이상 선택해 주세요.');
		return false;
	}
	window.open("profile.do?career="+boxs[0].checked+"&school="+boxs[1].checked+"&license="+boxs[2].checked, "_blank", "width=500,height=600");
