					...
					<div class="row match-height">
						<div class="col-md-6 col-12">
							<div class="card">
								...
								<c:if test="${param.smem==null}">
									<mytag:infoBtn mnum="${data.smem}" type="school"/>
								</c:if>
								<c:if test="${param.smem!=null}">
									<mytag:infoBtn mnum="${param.smem}" type="school"/>
								</c:if>
								<%-- <mytag:infoBtn mnum="${data.smem}" type="school" /> --%>
								<!-- 데이터가 없는 경우 -->
								<c:if test="${data==null}">
									...
									<div class="card-content">
										<div id="iconWrapper">
											...
											<c:if test="${first==null}">
												<a href="getSchool.do?smem=${data.smem}&pnum=${pnum-1}"
													class="">
													<!-- <i
												...
												<div class="form-body">
													...
													<div class="col-12">
														<div class="form-group has-icon-left">
															...
															<div class="position-relative">
																<input type="text" class="form-control edit"
																placeholder="최종학력여부 Y, N" id="password-id-icon"
																	name="finish" value="${data.finish}" readonly>
																<div class="form-control-icon">
																	<i class="fas fa-angle-double-right"></i>
																</div>
															</div>
