												...
												<div class="row">
														...
														<div class="form-group has-icon-left">
															...
															<div class="position-relative">
																<input type="date" class="form-control"
																	placeholder="Email" id="email-id-icon" name="startDate" required>
													...
													<div class="col-12">
														...
														<div class="form-group has-icon-left">
															...
															<div class="position-relative">
																<input type="date" class="form-control"
																	placeholder="Email" id="email-id-icon" name="birthDate" required>
																<div class="form-control-icon">
																	<i class="fas fa-angle-double-right"></i>
																</div>
															</div>
													...
													<div class="col-12">
														<div class="form-group has-icon-left">
															...
															<div class="position-relative">
																<input type="text" class="form-control"
																	placeholder="부서명" id="mobile-id-icon" name="teamName" required>
																<div class="form-control-icon">
																	<i class="fas fa-angle-double-right"></i>
																</div>
															</div>
													...
													<div class="col-12">
														<div class="form-group has-icon-left">
															...
															<div class="position-relative">
																<input type="text" class="form-control"
																	placeholder="ex)인력관리" id="password-id-icon" name="duty" requireds>
																<div class="form-control-icon">
																	<i class="fas fa-angle-double-right"></i>
																</div>
															</div>
														...
														<div class="form-group has-icon-left">
															...
															<div class="position-relative">
																<input type="number" class="form-control"
																	placeholder="직급" id="password-id-icon" name="mrank" required>
																<div class="form-control-icon">
																	<i class="fas fa-angle-double-right"></i>
																</div>
															</div>
														...
														<div class="form-group has-icon-left">
															...
															<div class="position-relative">
																<input type="type" class="form-control"
																	placeholder="정규직/계약직" id="password-id-icon" name="mtype" required>
																<div class="form-control-icon">
																	<i class="fas fa-angle-double-right"></i>
																</div>
															</div>
