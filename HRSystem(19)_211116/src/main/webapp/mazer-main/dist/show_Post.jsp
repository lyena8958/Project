									...
									<div class="card-body">
										<form action="updatePost.do" method="post" class="form"
											...
											<div class="row">
													...
													<div class="form-group fullPost">
														...
														<fieldset class="form-group">
															<select class="form-select" id="basicSelect"
																name="category" style="background-color: #e9ecef;">
												...
												<c:if test="${data.result=='종결'}">
													<div class="col-md-6 col-12">
														<label for="last-name-column">처리결과</label>
														<fieldset class="form-group">
															<select class="form-select" id="resultSelect"
																name="result" onchange="resultSelColor();"
																style="background-color: #e9ecef;">
																<option id="Active" selected>종결</option>
															</select>
														</fieldset>
													</div>
												...
												<c:if test="${data.result!='종결'}">
													<div class="col-md-6 col-12">
														...
														<fieldset class="form-group">
															<select class="form-select" id="resultSelect"
																name="result" onchange="resultSelColor();">
																<option id="Active">종결</option>
																<option id="InActive" selected>진행중</option>
															</select>
														</fieldset>
													</div>
