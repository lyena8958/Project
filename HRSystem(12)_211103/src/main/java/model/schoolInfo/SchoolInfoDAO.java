...
public class SchoolInfoDAO {
	...
	//WRITER
	private String GET_LIST_WRITER = "SELECT * FROM SCHOOLINFO ORDER BY SMEM ASC, STARTDATE ASC";
	...
	public List<SchoolInfoVO> getList() {
		List<SchoolInfoVO> datas = jdbcTemplate.query(GET_LIST, new SchoolRowMapper());
