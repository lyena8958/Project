				...
				<section class="row">
					<div class="col-12 col-lg-9">
						<div class="row totalwrap" >
							<div class="col-6 col-lg-3 col-md-6" id="totalInfo">
								<div class="card">
									<div class="card-body px-3 py-4-5">
										<div class="row">
											...
											<div class="col-md-8">
												...
												<h6 class="font-extrabold mb-0">&nbsp;${infoData[0]} 명</h6>
											</div>
										</div>
									</div>
								</div>
							</div>
							<div class="col-6 col-lg-3 col-md-6 totalInfo">
								<div class="card">
									<div class="card-body px-3 py-4-5">
										<div class="row">
											<div class="col-md-4">
											...
											<div class="col-md-8">
												...
												<h6 class="font-extrabold mb-0">&nbsp;${infoData[1]} 명</h6>
											</div>
										</div>
									</div>
								</div>
									...
									<div class="card-body px-3 py-4-5">
										<div class="row">
											...
											<div class="col-md-8">
												...
												<h6 class="font-extrabold mb-0">&nbsp;${infoData[2]}명</h6>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="card">
									<div class="card-body px-3 py-4-5">
										<div class="row">
											...
											<div class="col-md-8">
												<h6 class="text-muted font-semibold">&nbsp;퇴직률</h6>
												<h6 class="font-extrabold mb-0">&nbsp;${infoData[3]}%</h6>
											</div>
										</div>
									</div>
								</div>
											...
											<table>
												<tr>
													...
													<td><input type="number"
														...
														placeholder="1 ~ 12year 입력" name="dCnt"></td>
