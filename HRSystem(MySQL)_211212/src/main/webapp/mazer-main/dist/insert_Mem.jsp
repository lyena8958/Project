														...
														<div class="form-group has-icon-left">
															...
															<fieldset class="form-group">
																<select class="form-select" id="basicSelect"
																	...
																	<option>DB팀</option>
																	<option>WebIT</option>
																	<option>MobileIT</option>
																	<option>Server팀</option>
																</select>
															</fieldset>
															<!-- 	<div class="position-relative">
																<input type="text" class="form-control"
														...
														<div class="form-group has-icon-left">
															...
															<fieldset class="form-group">
																<select class="form-select" id="basicSelect"
																	...
																	<i class="fas fa-angle-double-right"></i>
																	<option selected> 직접선택 </option>
																	<option>평가승진보상</option>
																	<option>채용</option>
																	<option>웹Back</option>
																	<option>웹Front</option>
																	<option>사내보안</option>
																	<option>비품관리</option>
																	<option>모바일Back</option>
																	<option>모바일Front</option>
																	<option>모바일서버관리</option>
																	<option>웹서버관리</option>
																	<option>재무관리</option>
																	<option>결산처리</option>
																	<option>해외영업</option>
