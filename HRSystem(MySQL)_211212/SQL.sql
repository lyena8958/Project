...
CREATE TABLE post(
	...
	result varchar(20) default '진행중' /*처리여부*/
); 
...
insert into hradmin (hnum, hmem, pw) values ((select nvl(max(hnum),0)+1 from hradmin), 1000, '1000');
...
SELECT * FROM LICENSEINFO ORDER BY LMEM ASC, GETDATE ASC;