	...
	<div id="app">
		...
		<div id="main" > <!-- style="float: left;" -->
			...
			<div class="btn-group-vertical" role="group"
				...
				<a href="getSchool.do?smem=${data.mnum}"><button type="button" class="btn btn-secondary">학력</button></a>
				<a href="getCareer.do?cmem=${data.mnum}"><button type="button" class="btn btn-secondary">경력</button></a>
				<a href="getLicense.do?lmem=${data.mnum}"><button type="button" class="btn btn-secondary">자격증</button></a>
			</div>
		</div>
