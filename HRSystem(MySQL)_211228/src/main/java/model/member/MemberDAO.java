...
public class MemberDAO {
	...
	// ´ÜÀÏ PKÁ¶È¸
	private String GET_PNUM = "SELECT AUTO_INCREMENT FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'krea123' AND TABLE_NAME = 'member'";
	...
	public List<MemberSet> getSetList() {
		...
		//setList
		List<MemberSet> result = new ArrayList<MemberSet>(); // ¹ÝÈ¯ÇÒ °´Ã¼List
