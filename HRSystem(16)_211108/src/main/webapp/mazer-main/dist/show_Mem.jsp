...
window.onload = function(){
	actRemove();
	document.getElementById("member").addClass("active");
	document.getElementById("memShow").addClass("active");
						...
						<div class="col-md-6 col-12">
							<div class="card">
								...
								<c:if test="${data.path!=null}">
									<img src="${data.path}" alt="증명사진" id="memImg">
								</c:if>

								<!-- <img src="imgMem/1001.jpg" alt="증명사진" id="memImg"> -->
