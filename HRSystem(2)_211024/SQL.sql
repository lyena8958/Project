...
values((select nvl(max(mnum),0)+1 from member),'루피', '2021-10-01', '9999-12-31', '1988-01-01', 'HR팀', '인사관리', '사원', 2);

insert into hradmin (hnum, id, pw, hmem) values
((select nvl(max(hnum),0)+1 from hradmin),'1111', '1111', 1);
