...
public class MemberDAO {
	...
	private String INSERT = "INSERT INTO MEMBER (MNUM, MNAME, PATH, STARTDATE, ENDDATE, BIRTHDATE, TEAMNAME, DUTY, POSITION, WORK, MRANK) VALUES ((SELECT NVL(MAX(MNUM),0)+1 FROM MEMBER), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
